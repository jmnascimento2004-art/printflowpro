-- PRINTFLOWPRO - Padrao real de rodape SEM funcao e SEM dollar quote
-- Execute este arquivo inteiro no Supabase SQL Editor.
--
-- Este SQL nao usa imagens fake.
-- Ele pega as imagens reais ja cadastradas em public.companies e salva
-- na tabela public.company_footer_badge_defaults para uso futuro no app.
...
select
  'printflow_default_footer_badges_simple_fix_ok' as status,
