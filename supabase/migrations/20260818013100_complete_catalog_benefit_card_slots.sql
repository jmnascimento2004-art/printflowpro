-- PRINTFLOWPRO - complete catalog benefit-card slots after legacy history divergence
-- Forward-only and additive: restores the historical title/subtitle/active fields
-- required by the existing seven-slot catalog model without changing permissions.
