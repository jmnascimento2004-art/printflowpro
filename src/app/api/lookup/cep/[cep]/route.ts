  ...
  try {
    ...
    if (data.erro) {
      return NextResponse.json(
        { error: 'CEP nao encontrado. Verifique o numero informado.' },
        { status: 404 }
      );
    }
    ...
    return NextResponse.json({ error: 'Nao foi possivel consultar o CEP agora. Preencha o endereco manualmente.' }, { status: 502 });
  }
}
