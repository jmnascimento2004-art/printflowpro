...
CREATE TABLE companies (
  ...
  show_payments_diners BOOLEAN DEFAULT FALSE,
  show_payments_amex BOOLEAN DEFAULT FALSE,
  show_payments_boleto BOOLEAN DEFAULT FALSE,
  show_payments_deposito BOOLEAN DEFAULT FALSE,
  show_payments_transferencia BOOLEAN DEFAULT FALSE,
  show_payments_pix BOOLEAN DEFAULT TRUE,
  
  -- Toggles de Entrega
  show_delivery_sedex BOOLEAN DEFAULT TRUE,
  show_delivery_pac BOOLEAN DEFAULT FALSE,
...
CREATE TABLE settings (
  ...
  pix_key_type TEXT,
  bank_name TEXT,
  profit_margin NUMERIC(5,2) DEFAULT 40.00,
